...
/*
 * choosing the Resolution value.
 * reads HEXSWITCH an masks the first two bytes
 * scales the value to match the CR1 input for the relevant resolution choosen by the wsitch
 * displays the choosen value on LED15-0 (6bit auflösung = 6LED 12bit = 12LED)
 * returns the value for the CR1
 */
